...
/obj/machinery/vending/access/command/build_access_list(list/access_lists)
	...
	access_lists["[ACCESS_HOS]"] = list( // SPLURT EDIT AND REPLACEMENT
		/obj/item/clothing/under/rank/security/splurt/head_of_security = 1,
		/obj/item/clothing/under/rank/security/splurt/head_of_security/skirt = 1,
		/obj/item/clothing/under/rank/security/splurt/head_of_security/suit = 1,
		/obj/item/clothing/under/rank/security/splurt/head_of_security/casual = 1,
		/obj/item/clothing/under/rank/security/splurt/head_of_security/turtleneck = 1,
		/obj/item/clothing/under/rank/security/splurt/head_of_security/turtleneck/skirt = 1,
		/obj/item/clothing/under/rank/security/splurt/head_of_security/battledress = 1,
		...
		/obj/item/clothing/suit/armor/hos/hos_formal/redsec = 1,
		...
		/obj/item/clothing/head/beret/sec/splurt/hos = 1,
		...
		/obj/item/clothing/head/hats/hos/shako = 1,
		...
		/obj/item/clothing/neck/tie/bunnytie/security/tied = 1,
