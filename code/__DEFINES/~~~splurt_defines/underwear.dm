...
/obj/item/clothing/underwear/briefs/##class_name{\
	name = /datum/sprite_accessory/clothing/underwear/##class_name::name; \
	icon = /datum/sprite_accessory/clothing/underwear/##class_name::icon; \
	worn_icon = /datum/sprite_accessory/clothing/underwear/##class_name::icon; \
	worn_icon_digi = /datum/sprite_accessory/clothing/underwear/##class_name::icon; \
	icon_state = /datum/sprite_accessory/clothing/underwear/##class_name::icon_state; \
	gender = /datum/sprite_accessory/clothing/underwear/##class_name::gender; \
	flags_1 = /obj/item/clothing/underwear/briefs::flags_1 | (IS_PLAYER_COLORABLE_1 * !(/datum/sprite_accessory/clothing/underwear/##class_name::use_static)); \
	supports_variations_flags = /datum/sprite_accessory/clothing/underwear/##class_name::has_digitigrade * CLOTHING_DIGITIGRADE_VARIATION || CLOTHING_DIGITIGRADE_VARIATION_NO_NEW_ICON; \
	body_parts_covered = /obj/item/clothing/underwear/briefs::body_parts_covered | /datum/sprite_accessory/clothing/underwear/##class_name::hides_breasts * CHEST; \
};\
...
/datum/sprite_accessory/clothing/underwear/##class_name{\
...
/obj/item/clothing/underwear/shirt/##class_name {\
	name = /datum/sprite_accessory/clothing/undershirt/##class_name::name; \
	icon = /datum/sprite_accessory/clothing/undershirt/##class_name::icon; \
	worn_icon = /datum/sprite_accessory/clothing/undershirt/##class_name::icon; \
	worn_icon_digi = /datum/sprite_accessory/clothing/undershirt/##class_name::icon; \
	icon_state = /datum/sprite_accessory/clothing/undershirt/##class_name::icon_state; \
	gender = /datum/sprite_accessory/clothing/undershirt/##class_name::gender; \
	flags_1 = /obj/item/clothing/underwear/shirt::flags_1 | (IS_PLAYER_COLORABLE_1 * !(/datum/sprite_accessory/clothing/undershirt/##class_name::use_static)); \
	body_parts_covered = /obj/item/clothing/underwear/shirt::body_parts_covered | GROIN * /datum/sprite_accessory/clothing/undershirt/##class_name::hides_groin; \
};\
...
/datum/sprite_accessory/clothing/undershirt/##class_name {\
...
/obj/item/clothing/underwear/shirt/bra/##class_name {\
	name = /datum/sprite_accessory/clothing/bra/##class_name::name; \
	icon = /datum/sprite_accessory/clothing/bra/##class_name::icon; \
	worn_icon = /datum/sprite_accessory/clothing/bra/##class_name::icon; \
	worn_icon_digi = /datum/sprite_accessory/clothing/bra/##class_name::icon; \
	icon_state = /datum/sprite_accessory/clothing/bra/##class_name::icon_state; \
	gender = /datum/sprite_accessory/clothing/bra/##class_name::gender; \
	flags_1 = /obj/item/clothing/underwear/shirt/bra::flags_1 | (IS_PLAYER_COLORABLE_1 * !(/datum/sprite_accessory/clothing/bra/##class_name::use_static)); \
};\
/datum/sprite_accessory/clothing/bra/##class_name {\
...
/obj/item/clothing/underwear/socks/##class_name {\
	name = /datum/sprite_accessory/clothing/socks/##class_name::name; \
	icon = /datum/sprite_accessory/clothing/socks/##class_name::icon; \
	worn_icon = /datum/sprite_accessory/clothing/socks/##class_name::icon; \
	worn_icon_digi = /datum/sprite_accessory/clothing/socks/##class_name::icon; \
	icon_state = /datum/sprite_accessory/clothing/socks/##class_name::icon_state; \
	flags_1 = /obj/item/clothing/underwear/socks::flags_1 | (IS_PLAYER_COLORABLE_1 * !(/datum/sprite_accessory/clothing/socks/##class_name::use_static)); \
};\
/datum/sprite_accessory/clothing/socks/##class_name {\
